    ...
    <section class="pt-16 md:pt-36">
      <div class="flex flex-col gap-12">
        ...
        <div class="flex flex-row gap-10 md:px-16 mx-6">
          <div class="flex flex-col gap-16 max-w-5xl">
            <!-- project overview -->
            ...
            >
              <div class="flex flex-col gap-7 md:gap-10 w-full">
                ...
                <img src="/src/assets/image/sipa-v1.png" alt="" />
                <div class="flex flex-col gap-4">
            ...
            >
              <div class="flex flex-col gap-7 md:gap-10 w-full">
                ...
                <img src="/src/assets/image/sipa-after.png" alt="" />
            ...
            >
              <div class="flex flex-col gap-7 md:gap-10 w-full">
                ...
                <div class="flex flex-col gap-6 w-full">
                  <img src="/src/assets/image/analy-cn.png" alt="" />
                  <img src="/src/assets/image/analy-user.png" alt="" />
                </div>
